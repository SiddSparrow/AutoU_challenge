    ...
    <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6 space-y-5">
      ...
      {mode === "text" && (
        <textarea
          ...
          className="w-full h-48 p-4 border border-gray-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700 placeholder-gray-400"
        />
      )}
