...
export function ResultCard({ result }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 p-6 space-y-5 animate-fade-in">
      ...
      <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-4">
        ...
        <p className="text-gray-700 dark:text-gray-200 text-sm">{result.summary}</p>
      </div>
    </div>
  );
}
